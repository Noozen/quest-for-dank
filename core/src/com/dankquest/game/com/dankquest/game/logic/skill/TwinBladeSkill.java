...
public class TwinBladeSkill extends Skill {
    ...
    public void draw(Batch batch, float playTime) {
        ...
        batch.draw(skillAnimation.getKeyFrame(playTime), Dank.targetList.get(2).heroActor.getX() - Dank.targetList.get(2).heroActor.getWidth(),Dank.targetList.get(2).heroActor.getY() - Dank.targetList.get(2).heroActor.getHeight());
    }
